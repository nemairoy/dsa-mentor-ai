...
Use this trace to understand Fenwick Tree: Point Update before writing code.
...
For Fenwick Tree: Point Update, focus on the state before and after each step. A correct explanation should say what changed, why it changed, and why the final answer follows from the rule.
