...
Use this trace to understand Segment Tree: Range Query Model before writing code.
...
For Segment Tree: Range Query Model, focus on the state before and after each step. A correct explanation should say what changed, why it changed, and why the final answer follows from the rule.
