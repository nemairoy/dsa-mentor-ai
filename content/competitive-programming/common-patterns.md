# Competitive Programming: Common Patterns

## Goal
Learn Common Patterns in Competitive Programming with theory, example, code, explanation, complexity, and practice.

## Theory
Common Patterns is a focused part of Competitive Programming. Learn the rule, the state it changes, and the invariant that makes the operation correct.

## Step-by-step example
Use this trace to understand Competitive Programming: Common Patterns before writing code.
...
```python
def competitive_programming_common_patterns(items):
    result = []
    for index, value in enumerate(items):
        result.append((index, value))
    return result

print(competitive_programming_common_patterns([3, 1, 4, 1, 5]))
```
...
For Competitive Programming: Common Patterns, focus on the state before and after each step. A correct explanation should say what changed, why it changed, and why the final answer follows from the rule.
