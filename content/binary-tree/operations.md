...
Understand common operations, constraints, and tradeoffs. The goal is to understand binary tree from first principles and connect it to practical problem solving.
...
```python
def binary_tree_operations(items):
    """Reference scaffold for Binary Tree: Operations."""
    result = []
...
print(binary_tree_operations([3, 1, 4, 1, 5]))
```
