...
Use this trace to understand Binary Tree: Preorder before writing code.
...
For Binary Tree: Preorder, focus on the state before and after each step. A correct explanation should say what changed, why it changed, and why the final answer follows from the rule.
