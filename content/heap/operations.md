...
Understand common operations, constraints, and tradeoffs. The goal is to understand heap from first principles and connect it to practical problem solving.
...
```python
def heap_operations(items):
    """Reference scaffold for Heap: Operations."""
    result = []
...
print(heap_operations([3, 1, 4, 1, 5]))
```
