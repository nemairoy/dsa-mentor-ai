...
Understand common operations, constraints, and tradeoffs. The goal is to understand linked list from first principles and connect it to practical problem solving.
...
```python
def linked_list_operations(items):
    """Reference scaffold for Linked List: Operations."""
    result = []
...
print(linked_list_operations([3, 1, 4, 1, 5]))
```
