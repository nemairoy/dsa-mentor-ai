...
Study the core principles, invariants, and correctness ideas. The goal is to understand linked list from first principles and connect it to practical problem solving.
...
```python
def linked_list_theory(items):
    """Reference scaffold for Linked List: Theory."""
    result = []
...
print(linked_list_theory([3, 1, 4, 1, 5]))
```
