...
Use this trace to understand Sorting: Quick Sort before writing code.
...
For Sorting: Quick Sort, focus on the state before and after each step. A correct explanation should say what changed, why it changed, and why the final answer follows from the rule.
