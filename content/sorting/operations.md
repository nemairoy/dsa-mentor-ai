...
Understand common operations, constraints, and tradeoffs. The goal is to understand sorting from first principles and connect it to practical problem solving.
...
```python
def sorting_operations(items):
    """Reference scaffold for Sorting: Operations."""
    result = []
...
print(sorting_operations([3, 1, 4, 1, 5]))
```
