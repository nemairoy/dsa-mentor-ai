...
Use this trace to understand Sorting: Heap Sort before writing code.
...
For Sorting: Heap Sort, focus on the state before and after each step. A correct explanation should say what changed, why it changed, and why the final answer follows from the rule.
