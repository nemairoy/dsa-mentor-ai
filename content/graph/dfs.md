...
## Goal
Learn DFS in Graph with theory, example, code, explanation, complexity, and practice.

## Theory
DFS is a focused part of Graph. Learn the rule, the state it changes, and the invariant that makes the operation correct.

## Step-by-step example
Use this trace to understand Graph: Dfs before writing code.
...
For Graph: Dfs, focus on the state before and after each step. A correct explanation should say what changed, why it changed, and why the final answer follows from the rule.
