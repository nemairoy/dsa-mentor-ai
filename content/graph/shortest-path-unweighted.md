...
Use this trace to understand Graph: Shortest Path Unweighted before writing code.
...
For Graph: Shortest Path Unweighted, focus on the state before and after each step. A correct explanation should say what changed, why it changed, and why the final answer follows from the rule.
