...
Study the core principles, invariants, and correctness ideas. The goal is to understand big theta from first principles and connect it to practical problem solving.
...
```python
def big_theta_theory(items):
    """Reference scaffold for Big Theta: Theory."""
    result = []
...
print(big_theta_theory([3, 1, 4, 1, 5]))
```
