...
Use this trace to understand Backtracking: Practice before writing code.
...
For Backtracking: Practice, focus on the state before and after each step. A correct explanation should say what changed, why it changed, and why the final answer follows from the rule.
