...
Study the core principles, invariants, and correctness ideas. The goal is to understand backtracking from first principles and connect it to practical problem solving.
...
```python
def backtracking_theory(items):
    """Reference scaffold for Backtracking: Theory."""
    result = []
...
print(backtracking_theory([3, 1, 4, 1, 5]))
```
