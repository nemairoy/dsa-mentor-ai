...
Understand common operations, constraints, and tradeoffs. The goal is to understand avl tree from first principles and connect it to practical problem solving.
...
```python
def avl_tree_operations(items):
    """Reference scaffold for AVL Tree: Operations."""
    result = []
...
print(avl_tree_operations([3, 1, 4, 1, 5]))
```
