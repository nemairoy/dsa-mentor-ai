...
Study the core principles, invariants, and correctness ideas. The goal is to understand avl tree from first principles and connect it to practical problem solving.
...
```python
def avl_tree_theory(items):
    """Reference scaffold for AVL Tree: Theory."""
    result = []
...
print(avl_tree_theory([3, 1, 4, 1, 5]))
```
