...
Use this trace to understand Algorithm Analysis: Asymptotic Notation before writing code.
...
For Algorithm Analysis: Asymptotic Notation, focus on the state before and after each step. A correct explanation should say what changed, why it changed, and why the final answer follows from the rule.
