...
Study the core principles, invariants, and correctness ideas. The goal is to understand recursion from first principles and connect it to practical problem solving.
...
```python
def recursion_theory(items):
    """Reference scaffold for Recursion: Theory."""
    result = []
...
print(recursion_theory([3, 1, 4, 1, 5]))
```
