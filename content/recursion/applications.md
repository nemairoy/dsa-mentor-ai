...
Connect the topic to real interview and engineering use cases. The goal is to understand recursion from first principles and connect it to practical problem solving.
...
```python
def recursion_applications(items):
    """Reference scaffold for Recursion: Applications."""
    result = []
...
print(recursion_applications([3, 1, 4, 1, 5]))
```
