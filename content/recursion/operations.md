...
Understand common operations, constraints, and tradeoffs. The goal is to understand recursion from first principles and connect it to practical problem solving.
...
```python
def recursion_operations(items):
    """Reference scaffold for Recursion: Operations."""
    result = []
...
print(recursion_operations([3, 1, 4, 1, 5]))
```
