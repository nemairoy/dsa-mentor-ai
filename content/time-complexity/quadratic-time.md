...
Use this trace to understand Time Complexity: Quadratic Time before writing code.
...
For Time Complexity: Quadratic Time, focus on the state before and after each step. A correct explanation should say what changed, why it changed, and why the final answer follows from the rule.
