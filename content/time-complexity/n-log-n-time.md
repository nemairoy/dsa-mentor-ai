# Time Complexity: N Log N Time

## Goal
Learn N Log N Time in Time Complexity with theory, example, code, explanation, complexity, and practice.
...
```python
def time_complexity_n_log_n_time(items):
    result = []
    for index, value in enumerate(items):
        result.append((index, value))
    return result

print(time_complexity_n_log_n_time([3, 1, 4, 1, 5]))
```
