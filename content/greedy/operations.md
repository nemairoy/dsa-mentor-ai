...
Understand common operations, constraints, and tradeoffs. The goal is to understand greedy from first principles and connect it to practical problem solving.
...
```python
def greedy_operations(items):
    """Reference scaffold for Greedy: Operations."""
    result = []
...
print(greedy_operations([3, 1, 4, 1, 5]))
```
