...
Understand common operations, constraints, and tradeoffs. The goal is to understand searching from first principles and connect it to practical problem solving.
...
```python
def searching_operations(items):
    """Reference scaffold for Searching: Operations."""
    result = []
...
print(searching_operations([3, 1, 4, 1, 5]))
```
