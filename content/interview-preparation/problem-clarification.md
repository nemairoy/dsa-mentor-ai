...
Use this trace to understand Interview Preparation: Problem Clarification before writing code.
...
For Interview Preparation: Problem Clarification, focus on the state before and after each step. A correct explanation should say what changed, why it changed, and why the final answer follows from the rule.
