...
Understand common operations, constraints, and tradeoffs. The goal is to understand deque from first principles and connect it to practical problem solving.
...
```python
def deque_operations(items):
    """Reference scaffold for Deque: Operations."""
    result = []
...
print(deque_operations([3, 1, 4, 1, 5]))
```
