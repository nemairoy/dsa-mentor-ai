...
Study the core principles, invariants, and correctness ideas. The goal is to understand deque from first principles and connect it to practical problem solving.
...
```python
def deque_theory(items):
    """Reference scaffold for Deque: Theory."""
    result = []
