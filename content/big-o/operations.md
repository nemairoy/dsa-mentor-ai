...
Understand common operations, constraints, and tradeoffs. The goal is to understand big o from first principles and connect it to practical problem solving.
...
```python
def big_o_operations(items):
    """Reference scaffold for Big O: Operations."""
    result = []
...
print(big_o_operations([3, 1, 4, 1, 5]))
```
