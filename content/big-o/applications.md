...
Connect the topic to real interview and engineering use cases. The goal is to understand big o from first principles and connect it to practical problem solving.
...
```python
def big_o_applications(items):
    """Reference scaffold for Big O: Applications."""
    result = []
...
print(big_o_applications([3, 1, 4, 1, 5]))
```
