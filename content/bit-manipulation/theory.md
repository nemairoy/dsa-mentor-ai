...
Study the core principles, invariants, and correctness ideas. The goal is to understand bit manipulation from first principles and connect it to practical problem solving.
...
```python
def bit_manipulation_theory(items):
    """Reference scaffold for Bit Manipulation: Theory."""
    result = []
...
print(bit_manipulation_theory([3, 1, 4, 1, 5]))
```
